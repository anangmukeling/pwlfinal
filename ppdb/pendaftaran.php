...
include "koneksi.php";
                if(isset($_POST['nama'])){
                                ...
                                mysqli_query($konek,"insert into pendaftar values('','$nama','$jenkel','$kdagama','$tpt_lahir','$tgl_lahir','$alamat',
...
<body>
	...
	<div class="navbar navbar-inverse">
		<div class="container">
			<div class="navbar-header">
				...
				<marquee> SD NEGERI 12 SRAGEN</marquee></a> 
			</div>
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
          <li class="c1"><a href="./"><span class="fa fa-home"></span><strong> Home</strong></a></li>
          <li class="c2"><a href="pengumuman.php" target="_blank"><span class="fa fa-users"></span><strong> Pengumuman</strong></a></li>
          <li class="c3 active"><a href="pendaftaran.php" target="_blank"><span class="fa fa-pencil"></span><strong> Pendaftaran</strong></a></li>
      ...
      <div class="modal-body">
        ...
        <table class="table " width="100%">
          <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="nama" name="nama" placeholder="Nama Lengkap" class="form-control" type="text" required></td>
            </tr>
            <tr>
            ...
            <td><select  name="kdagama"   class="form-control" required>
              ...
              <?php
                $exec=mysqli_query($konek,"select * from agama");
            ...
            <td width="1%"> : </td>
            <td><select  name="kdtk"   class="form-control" required>
              <?php
                $exec=mysqli_query($konek,"select * from tk");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[1]'> $hasil[1]</option>";
              ?>
            </select></td>
            ...
            <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="tgl_lahir" name="tgl_lahir" placeholder="Contoh : 1998-Bulan-Tanggal" class="form-control"  type="text" required></td>
            </tr>
            <tr>
                <th width="25%">Alamat Lengkap</th>
                <td width="1%"> : </td>
                <td> <input id="alamat" name="alamat" placeholder="Alamat Lengkap" class="form-control" type="textarea" required></td>
            </tr>
            <tr>
            ...
            <td width="1%"> : </td>
            <td><select  name="kdpendidikana"   class="form-control" placeholder="Pilih" value="Pilih" required >
            
              <?php
                $exec=mysqli_query($konek,"select * from pendidikan");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[1]'> $hasil[1]</option>";
              ?>
            </select></td>
           ...
           <tr>
            ...
            <td><select  name="kdpekerjaana"   class="form-control" required>
              ...
              <?php
                $exec=mysqli_query($konek,"select * from pekerjaan");
                while($hasil=mysqli_fetch_array($exec))
                  echo "<option value='$hasil[1]'> $hasil[1]</option>";
              ?>
            </select></td>
 ...
 <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="penghasilanayah" name="penghasilanayah" placeholder="Contoh : 2.000.000" class="form-control" type="text" required ></td>
            </tr>
 <tr>
          ...
          <tr>
                ...
                <td width="1%"> : </td>
                <td> <input id="nohp" name="nohp" placeholder="No telepon" class="form-control" type="text" required ></td>
            </tr>
           <tr>
                <th width="25%">Upload Formulir</th>
                <td width="1%"> : </td>
                <td><button type="button" id="tambah" onClick=""class="btn btn-primary"><i class="fa fa-plus"></i>&nbsp;Upload File</button></td>
            </tr>
            <input type="hidden" name="statusdaftar" value="tahap seleksi">
        </table>
        <br>
        *) Isi data dengan benar da teliti <br>
        *) Jika anda Anda bingung silakan menghubungi kontak yang dilampirkan <br>
