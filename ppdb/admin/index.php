            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="./"><i class="fa fa-home" data-original-title="" title=""></i> <strong>Pendaftan Online - SD N 12 Sragen</strong></a>
                    </div>
                    <!-- end:navbar-header -->
        ...
        <div class="container">
          ...
          <?php
           $table = "pendaftar";
                        ...
                        $sql_pendaftar = "SELECT * FROM $table";
                        $query = mysqli_query($konek,$sql_pendaftar);
                        $jml_pendaftar = mysqli_num_rows($query);


                        $sql_diterima = "SELECT count(statusdaftar) as jumlah from $table where statusdaftar='Diterima'";
                        $query2 = mysqli_query($konek,$sql_diterima);
                        $diterima = mysqli_fetch_array($query2);


                        $sql_ditolak = "SELECT count(statusdaftar) as jumlah from $table where statusdaftar='Ditolak'";
                        $query3 = mysqli_query($konek,$sql_ditolak);
                        $ditolak = mysqli_fetch_array($query3);
                            ...
                            <div class='col-lg-6 col-sm-6'>
                                <section class='panel'>
                                    <div class='symbol terques'>
                                        <i class='fa fa-users' data-original-title=' Jumlah Pendaftar'></i>
                                    </div>
                                    <div class='value'>
                                        <h1 class=''>$jml_pendaftar</h1>
                                        <p>Pendaftar</p>
                                    </div>
                                </section>
                            </div>
                            <div class='col-lg-6 col-sm-6'>
                                <section class='panel'>
                                    <div class='symbol red'>
                                        <i class='fa fa-gift' data-original-title=' Lolos Seleksi'></i>
                                    </div>
                                    <div class='value'>
                                        <h1 class=''>$diterima[jumlah]</h1>
                                        <p>Diterima</p>
                                    </div>
                                </section>
                            </div>
                            <div class='col-lg-6 col-sm-6'>
                                <section class='panel'>
                                    <div class='symbol yellow'>
                                        <i class='fa fa-shopping-cart' data-original-title='Gagal Masuk'></i>
                                    </div>
                                    <div class='value'>
                                        <h1 class=''>$ditolak[jumlah]</h1>
                                        <p>Ditolak</p>
                                    </div>
                                </section>
                            </div>
                            <div class='col-lg-6 col-sm-6'>
                                <section class='panel'>
                                    <div class='symbol purple'>
                                        <i class='fa fa-money' data-original-title=' Total Seleksi'></i>
                                    </div>
                                    <div class='value'>
                                        <h1 class=''>1</h1>
                                        <p>Tahap Seleksi</p>
                ...
                <div class="footer-bottom-widget">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            © 2018 <strong>Rouse House Group</strong></p>
                        </div>
                        <div class="col-sm-6">
                            <p class="footer-bottom-links">
                                <a href="#">About <strong></strong></a>
                                <a href="#" target="_blank">: Rouse House</a>
