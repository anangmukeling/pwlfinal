...
<table class="table table-striped">
    ...
    <?php
        ...
        $exec=mysqli_query($konek,"select * from pendaftar ");
            ...
            $exec=mysqli_query("select * from pendaftar where kdpendaftar like '%".$data."%' or nama like '%".$data."%'");
        }
    ...
    <tr>
        ...
        <td>
            ...
            <a href="laporan/cetakformulir.php?kdpendaftar=<?php echo $r[0];  ?>"><button type="button" class="btn btn-primary"><span class='fa fa-print'></span> Cetak Formulir Pendaftar</button></a>
