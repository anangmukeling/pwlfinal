...
include "../koneksi.php";
                if(isset($_POST['nama'])){
                                ...
                                mysqli_query("insert into pendaftar values('','$nama','$jenkel','$kdagama','$tpt_lahir','$tgl_lahir','$alamat',
            ...
            <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="http://bootemplates.com/themes/srikandi/v2/index.html"><i class="fa fa-home" data-original-title="" title=""></i> <strong>Pendafta</strong>Ran<strong>.</strong></a>
                    </div>
                    <!-- end:navbar-header -->
      ...
      <div class="modal-body">
        ...
        <table class="table " width="100%">
          <tr>
            ...
            <td width="1%"> : </td>
            <td><select  name="kdtk"   class="form-control" required style="color:lime">
                ...
                <div class="footer-bottom-widget">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            © 2014 <strong>Titin Ariska Sibarani</strong></p>
                        </div>
                        <div class="col-sm-6">
