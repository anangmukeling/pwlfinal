...
<?php
  ...
  if(isset($_POST['username']) && isset($_POST['password']))
  {
      ...
      if(trim($_POST['username']!="") && trim($_POST['password']!="" ))
      {
        ...
        $exec=mysqli_query($konek,"select * from login where username='$userpost'");
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red"></span>
									<span class="white" id="id-text2">PPDB ONLINE</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; SD NEGERI 12 SRAGEN</h4>
								<h6 style="color: white">Jl. dr. Soetomo No.04 Sragen</h6>
							</div>
