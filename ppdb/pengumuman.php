		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right mainNav">
                    ...
                    <li class="c2 active"><a href="pengumuman.php" target="_blank"><span class="fa fa-users"></span><strong> Pengumuman</strong></a></li>
                    <li class="c3"><a href="pendaftaran.php" target="_blank"><span class="fa fa-pencil"></span><strong> Pendaftaran</strong></a></li>
      ...
      <div class="modal-body">
        ...
        <table class="table table-striped" width="100%">
            ...
            <td><select id="no_pelanggan_terdekat" name="no_pelanggan_terdekat"   class="form-control">
              ...
              <?php
                $exec=mysqli_query($konek,"select * from pelanggan");
...
<table class="table table-striped">
    ...
    <?php
        if(!isset($_GET['data']))
        $exec=mysqli_query($konek,"select * from pendaftar ");
        else{
            $data=trim(addslashes($_GET['data']));
            $exec=mysqli_query($konek,"select * from pendaftar where kdpendaftar like '%".$data."%' or nama like '%".$data."%'");
        }
